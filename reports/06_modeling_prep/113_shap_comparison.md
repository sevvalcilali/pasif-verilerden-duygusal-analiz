...
Hibrit modelde SHAP katkısının kategori dağılımı:
- EMA türetilen: 0.2514 (%68.1)
- EMA ham: 0.0984 (%26.6)
- Pasif: 0.0128 (%3.5)
- EMA pam one-hot: 0.0068 (%1.8)

Yani hibrit modelin kararı neredeyse tamamen EMA'dan geliyor; pasif feature'lar
%3.5'te kalıyor. Bu, etiketin EMA'dan üretilmesinden kaynaklı leakage'ın somut
göstergesi — model cascade kuralını yeniden öğreniyor.

Pasif modelde ise en güçlü feature'lar gerçek davranış sinyalleri (telefon
kullanımı, hareketlilik, ses), Wang 2014 paradigmasıyla uyumlu. F1 daha düşük
ama öğrenilen şey gerçek. İki modeli yan yana koyunca leakage farkı net görünüyor.
